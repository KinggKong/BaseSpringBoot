...
import com.global.project.WebConfiguration.JwtConfig.JwtProvider;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@RequestBody LoginRequest loginRequest) {
        ...
        String jwt = jwtUtils.generateTokenByUsername(userDetails.getUsername());
            return ResponseEntity.ok(new JwtResponse(userDetails.getUser().getId(), "Bearer", jwt, userDetails.getUsername(), userDetails.getUser().getEmail(),
